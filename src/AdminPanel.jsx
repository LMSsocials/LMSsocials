...
export default function AdminPanel() {
  ...
  const createProduct = async (event) => {
    ...
    await postVoucher({ action: 'createProduct', ...Object.fromEntries(new FormData(form)) }, form)
  }
    ...
    {tab === 'vouchers' ? <>
      <div className='admin-grid voucher-admin-grid'>
        <form onSubmit={createProduct}>
          ...
          <div className='admin-form-row'><label>Price (NGN)<input name='price' type='number' min='100' step='50' required /></label><label>Image URL<input name='imageUrl' placeholder='/assets/log-product.png' /></label></div>
